            ...
            <h1>É facil, comece fazendo seu primeiro commit!</h1>
                <div className="card">
                    ...
                    <div className="sideB">
                        ...
                        <a href="https://guides.github.com/activities/hello-world/#what" target="_blank">GitHub Guides</a>
                    </div>
                </div>
                <div className="card">
                    <div className='sideA'>
                    ...
                    <div className="sideB">
                        ...
                        <a href="https://guides.github.com/activities/hello-world/#repository" target="_blank">GitHub Guides</a>
                    </div>
                </div> 
                <div className="card">
                    <div className='sideA'>
                        ...
                        <a href="https://guides.github.com/activities/hello-world/#branch" target="_blank">GitHub Guides</a>
                    </div>
                </div> 
                <div className="card">
                    <div className='sideA'>
                        ...
                        <a href="https://guides.github.com/activities/hello-world/#commit" target="_blank">GitHub Guides</a>
                    </div>
                </div> 
                <div className="card">
                    <div className='sideA'>
                        ...
                        <a href="https://guides.github.com/activities/hello-world/#pr" target="_blank">GitHub Guides</a>
                    </div>
                </div>
                <div className="card">
                    <div className='sideA'>
